...
Die "HTTP API v2" sollte aktiviert werden, ohne 1P/3P-Phasenumschaltung reicht auch die "HTTP-API v1".
Beides kann in der go-e App ("Einstellungen" > "Zugriff auf lokale HTTP-API v2 zulassen" bzw weiter unten auch für "v1") gesetzt werden.
Mit aktueller Firmware ist "v1" aber hinfällig, wenn man sie nicht anderweitig nutzt.
